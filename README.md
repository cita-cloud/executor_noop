...
## 编译docker镜像
```
docker build -t citacloud/executor_noop .
```
...
1. `config` 微服务配置文件。
    ...
    * `domain` 节点的域名
    ...
    其中`[executor_noop.log_config]`段为微服务日志的配置：
    * `max_level` 日志等级
    * `filter` 日志过滤配置
...
2023-02-08T08:29:09.898895Z  INFO executor: grpc port of executor_noop: 50002
...
2023-02-08T08:29:10.317068Z  INFO executor: start executor_noop grpc server
