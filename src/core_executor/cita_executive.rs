...
use crate::core_executor::data_provider::Store as VMSubState;
use crate::types::Bytes;
use crate::types::{Address, H160, H256, U256, U512};
use cita_trie::DB;
use cita_vm::{
    evm::{Context as EVMContext, Contract, InterpreterParams, InterpreterResult, Log as EVMLog},
...
use crate::core_executor::cita_vm_helper::get_interpreter_conf;
...
impl<'a, B: DB + 'static> CitaExecutive<'a, B> {
    pub fn new(state: Arc<RefCell<State<B>>>, context: &'a Context) -> Self {
        Self {
